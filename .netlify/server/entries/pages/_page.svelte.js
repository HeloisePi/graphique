...
const css$2 = {
  code: "section.svelte-1k0cxf4{width:100vw;height:90vh;display:flex;flex-direction:column;justify-content:center;align-items:center}p.svelte-1k0cxf4{width:40vw;text-align:center}img.svelte-1k0cxf4{position:absolute;transform:translateY(18vw);width:100vw}@media screen and (max-width: 720px){p.svelte-1k0cxf4{width:60vw}}@media screen and (max-width: 400px){h1.svelte-1k0cxf4{font-size:50px;text-align:center}p.svelte-1k0cxf4{width:90vw}}",
  map: null
};
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<section class="svelte-1k0cxf4" data-svelte-h="svelte-4vm72r"><h1 class="svelte-1k0cxf4">Team PinPin</h1> <p class="svelte-1k0cxf4">“Les deux arts d’écrire et de dessiner
         sont naturellement associés.” (Charles Dickens)</p> <img src="/images/line/line2.svg" alt="line" class="svelte-1k0cxf4"> </section>`;
});
const Saga_svelte_svelte_type_style_lang = "";
const css$1 = {
...
const Saga = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="contenaireSaga svelte-1rlh8v2" id="saga"><img src="/images/book.webp" alt="Livre saga" class="svelte-1rlh8v2"> <div class="svelte-1rlh8v2"><h2 data-svelte-h="svelte-1vi56nr">La Saga QUATRE</h2> <p data-svelte-h="svelte-q5dtow">QUATRE, romans de fantasy, suit les aventures de Rashele, Dyane,
            ...
            Mariane Gahengi et Serge Pingitore, autrices et illustrateur, vous proposent
             ...
             et à la bande dessinée pour emmener le lecteur dans l’imaginaire narratif.</p> ${validate_component(Bouton, "Bouton").$$render($$result, { src: "/saga" }, {}, {
    default: () => {
      return `Voir plus`;
    }
  })}</div> </section>`;
