...
import { G as GridImage, a as lesnoirsetblancs } from "../../../../chunks/imagesList.js";
  ...
  return `${validate_component(FilAriane, "FilAriane").$$render(
    ...
    default: () => {
      return `${each(lesnoirsetblancs, (src) => {
        return `<img${add_attribute("src", src, 0)} alt="tableau Serge Pingitore sur le théme du noir et blanc" class="svelte-42ysri">`;
      })}`;
    }
  })} </div>`;
});
