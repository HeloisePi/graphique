...
import { G as GridImage, p as paysage } from "../../../../chunks/imagesList.js";
  ...
  return `${validate_component(FilAriane, "FilAriane").$$render(
    ...
    default: () => {
      return `${each(paysage, (src) => {
        return `<img${add_attribute("src", src, 0)} alt="tableau Serge Pingitore sur le théme des paysages" class="svelte-42ysri">`;
      })}`;
    }
  })} </div>`;
});
